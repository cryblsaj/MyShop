...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "test@test.mil", ZipCode = "00000" });

            IPrincipal fakeUser = new GenericPrincipal(new GenericIdentity("test@test.mil", "Forms"), null);
